...
module.exports = async (client) => {
    try {
        try {
            ...
            console.log(`     ┃ `.bold.brightGreen + " ".repeat(-1 + stringlength - ` ┃ `.length) + "┃".bold.brightGreen)
            console.log(`     ┃ `.bold.brightGreen + `  /-/ Discord: T𝕯𝖔𝖔𝖒𝖘𝕯𝖆𝖞𝕮𝖑𝖆𝖓𝕻𝖍𝖎𝖑𝖎𝖕 /-/`.bold.brightGreen + " ".repeat(-1 + stringlength - ` ┃ `.length - `  /-/ By Discord: 𝕯𝖔𝖔𝖒𝖘𝕯𝖆𝖞𝕮𝖑𝖆𝖓𝕻𝖍𝖎𝖑𝖎𝖕 /-/`.length) + "   ┃".bold.brightGreen)
            console.log(`     ┃ `.bold.brightGreen + " ".repeat(-1 + stringlength - ` ┃ `.length) + "┃".bold.brightGreen)
            console.log(`     ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛`.bold.brightGreen)
        } catch {
            /* */ }
